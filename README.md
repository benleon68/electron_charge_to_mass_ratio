...
- `data/` – experimental data files used in the analysis
- `notebooks/` – Jupyter notebook containing calculations, code, plots, and discussion
- `plots/` – exported figures generated using Python
